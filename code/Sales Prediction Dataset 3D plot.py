# Sales Prediction Analysis using Advertising Dataset (Fixed for Excel and Non-Numeric Columns with 3D Visualization)
...
# --- Q4 Extra: 3D Visualization of Regression Plane ---
fig = plt.figure(figsize=(10, 7))
ax = fig.add_subplot(111, projection='3d')

ax.scatter(df['TV'], df['Radio'], df['Sales'], color='blue', alpha=0.5, label='Actual Sales')
ax.set_xlabel('TV')
ax.set_ylabel('Radio')
ax.set_zlabel('Sales')
